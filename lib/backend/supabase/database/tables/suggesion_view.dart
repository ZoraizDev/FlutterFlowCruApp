...
class SuggesionViewTable extends SupabaseTable<SuggesionViewRow> {
  @override
  String get tableName => 'suggesion_view';

  @override
  SuggesionViewRow createRow(Map<String, dynamic> data) =>
      SuggesionViewRow(data);
}

class SuggesionViewRow extends SupabaseDataRow {
  SuggesionViewRow(super.data);

  @override
  SupabaseTable get table => SuggesionViewTable();
