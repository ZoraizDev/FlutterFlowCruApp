...
class ViewNameTable extends SupabaseTable<ViewNameRow> {
  @override
  String get tableName => 'view_name';

  @override
  ViewNameRow createRow(Map<String, dynamic> data) => ViewNameRow(data);
}

class ViewNameRow extends SupabaseDataRow {
  ViewNameRow(super.data);

  @override
  SupabaseTable get table => ViewNameTable();
