...
class GetsuggestionsTable extends SupabaseTable<GetsuggestionsRow> {
  @override
  String get tableName => 'getsuggestions';

  @override
  GetsuggestionsRow createRow(Map<String, dynamic> data) =>
      GetsuggestionsRow(data);
}

class GetsuggestionsRow extends SupabaseDataRow {
  GetsuggestionsRow(super.data);

  @override
  SupabaseTable get table => GetsuggestionsTable();
