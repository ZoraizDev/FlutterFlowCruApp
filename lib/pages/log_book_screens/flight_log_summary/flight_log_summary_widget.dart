...
import 'flight_log_summary_model.dart';
export 'flight_log_summary_model.dart';

class FlightLogSummaryWidget extends StatefulWidget {
  const FlightLogSummaryWidget({super.key});

  @override
  State<FlightLogSummaryWidget> createState() => _FlightLogSummaryWidgetState();
}

class _FlightLogSummaryWidgetState extends State<FlightLogSummaryWidget> {
  late FlightLogSummaryModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FlightLogSummaryModel());
                                        ...
                                        children: [
                                          ...
                                          Align(
                                            alignment:
                                                const AlignmentDirectional(-1.0, 0.0),
                                            child: Text(
                                              'Select the amount of Day and Night landings',
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
                                                      .override(
