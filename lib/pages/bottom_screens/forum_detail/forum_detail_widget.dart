...
import 'forum_detail_model.dart';
export 'forum_detail_model.dart';

class ForumDetailWidget extends StatefulWidget {
  const ForumDetailWidget({
    super.key,
  ...
  @override
  State<ForumDetailWidget> createState() => _ForumDetailWidgetState();
}

class _ForumDetailWidgetState extends State<ForumDetailWidget> {
  late ForumDetailModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ForumDetailModel());
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            FutureBuilder<List<ForumThreadsRow>>(
                              future: ForumThreadsTable().queryRows(
                                queryFn: (q) => q.eq(
                                  'forum_id',
                                  widget.forumID,
                                ),
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<ForumThreadsRow>
                                    listViewForumThreadsRowList =
                                    snapshot.data!;
                                return ListView.builder(
                                  padding: EdgeInsets.zero,
                                  shrinkWrap: true,
                                  scrollDirection: Axis.vertical,
                                  itemCount: listViewForumThreadsRowList.length,
                                  itemBuilder: (context, listViewIndex) {
                                    final listViewForumThreadsRow =
                                        listViewForumThreadsRowList[
                                            listViewIndex];
                                    return Padding(
                                      padding: const EdgeInsetsDirectional.fromSTEB(
