                        ...
                        child: SingleChildScrollView(
                          child: Column(
                            ...
                            children: [
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: Row(
                                        mainAxisSize: MainAxisSize.max,
                                        children: [
                                          if (FFAppState().isPilotForumOpen)
                                            InkWell(
                                              splashColor: Colors.transparent,
                                              focusColor: Colors.transparent,
                                              hoverColor: Colors.transparent,
                              ...
                              if (FFAppState().isPilotForumOpen == true)
                                Flexible(
                                  child: FutureBuilder<ApiCallResponse>(
                                    future: PilotForumsCall.call(
                                      searchForm: _model.textController.text,
                                    ),
                                    builder: (context, snapshot) {
                                      ...
                                      final columnPilotForumsResponse =
                                          snapshot.data!;
                                      return Builder(
                                        builder: (context) {
                                          final pilotForumList =
                                              columnPilotForumsResponse.jsonBody
                                                  .toList();
                                          return Column(
                                            mainAxisSize: MainAxisSize.max,
                                            children: List.generate(
                                                pilotForumList.length,
                                                (pilotForumListIndex) {
                                              final pilotForumListItem =
                                                  pilotForumList[
                                                      pilotForumListIndex];
                                              return Padding(
                              ...
                              if (FFAppState().isOwnerForumOpen)
                                Flexible(
                                  child: Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(
                                        0.0, 0.0, 0.0, 140.0),
                                    child: FutureBuilder<ApiCallResponse>(
                                      future: OwnerForumCall.call(
                                        searchForm: _model.textController.text,
                                      ),
                                      builder: (context, snapshot) {
                                        // Customize what your widget looks like when it's loading.
                                        ...
                                        final columnOwnerForumResponse =
                                            snapshot.data!;
                                        return Builder(
                                          builder: (context) {
                                            final ownerForumList =
                                                columnOwnerForumResponse
                                                    .jsonBody
                                                    .toList();
                                            return Column(
                                              mainAxisSize: MainAxisSize.max,
                                              children: List.generate(
                                                  ownerForumList.length,
                                                  (ownerForumListIndex) {
                                                final ownerForumListItem =
                                                    ownerForumList[
                                                        ownerForumListIndex];
                                                return Padding(
                                                  padding: const EdgeInsetsDirectional
