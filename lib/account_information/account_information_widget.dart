                                        ...
                                        child: Padding(
                                          padding:
                                              const EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 0.0, 0.0, 10.0),
                                          child:
                                              FutureBuilder<List<PositionRow>>(
                                            future: PositionTable().queryRows(
                                              queryFn: (q) => q,
                                            ),
                                            builder: (context, snapshot) {
                                              ...
                                              List<PositionRow>
                                                  positionDropDownPositionRowList =
                                                  snapshot.data!;
                                                    ...
                                                    child: Padding(
                                                      ...
                                                      child: FutureBuilder<
                                                        ...
                                                        builder: (context,
                                                          ...
                                                          List<CompanyRow>
                                                              companyDropDownCompanyRowList =
                                                              snapshot.data!;
                                                          return FlutterFlowDropDown<
                                                              String>(
                                                            controller: _model
                                                                    .companyDropDownValueController ??=
                                                                FormFieldController<
                                                                        String>(
                                                                    null),
                                                            options:
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: FutureBuilder<
                                                      ...
                                                      builder:
                                                        ...
                                                        List<PlaceRow>
                                                            placeDropDownPlaceRowList =
                                                            snapshot.data!;
                                                        return FlutterFlowDropDown<
                                                            String>(
                                                          controller: _model
                                                                  .placeDropDownValueController ??=
                                                              FormFieldController<
                                                                  String>(null),
                                                          options: List<
                                                                  String>.from(
                              ...
                              child: wrapWithModel(
                                ...
                                child: BottomButtonsWidget(
                                  ...
                                  rightButtonAction: () async {
                                    if (((functions.checkDropdownSelected(_model
                                                    .positionDropDownValue) !=
                                                '') &&
                                        ...
                                        (_model.companyDropDownValue != null &&
                                            _model.companyDropDownValue !=
                                                '') &&
                                        (_model.placeDropDownValue != null &&
                                            _model.placeDropDownValue != '') &&
                                        (_model.datePicked1 != null) &&
                                        (_model.datePicked2 != null)) {
                                      _model.acountsetup =
                                          await WorkHistoryTable().insert({
                                        'postion_id':
                                            FFAppState().selectedPositionID,
                                        'place_id':
                                            FFAppState().selectedPlaceID,
                                        'company_id':
                                      ...
                                      context
                                          .pushNamed('ProfileCreationSuccess');
                                    } else {
